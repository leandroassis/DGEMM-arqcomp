...
void dgemm_AVX_BLOCK(const size_t, double *, double *, double *);
void do_block(const size_t, const size_t, const size_t, const size_t, double *, double *, double *);
